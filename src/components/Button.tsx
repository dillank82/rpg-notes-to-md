...
export const Button = (props: ButtonProps) => {
    const baseStyles = 'bg-violet-500 text-white py-2.5 px-5 m-2 rounded-lg disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-solid focus:outline-black focus:outline-2'
    if (props.as === 'a') {
